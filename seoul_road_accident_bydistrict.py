...
for ax in axs:
    data_filtered = data[data["district"]==ax]
...
lgd.annotate('구', xy=(min(x_values)+0.2, height-1), xycoords='data', xytext=(0, 16), textcoords='offset points', 
...
#서북
#도심
서울시 = df[(df["district"]=="서울시") & (df["category"]==Category) & (df["harm"]==Harm)]["2021"].iloc[0]
